...
const en = {
  ...
  review: { eyebrow: "Free assessment", title: "Upload a room photo for a free assessment", body: "You do not need to share the property name or URL first. Upload a room photo, leave your email and we’ll review what can be improved.", includes: ["3 photo optimization recommendations", "1 complimentary sample image", "OTA presentation analysis"], fields: ["Property Name", "Property or OTA URL", "Email", "WhatsApp", "Message"], messagePlaceholder: "Tell us what you would like to improve, if anything specific comes to mind.", consent: "By submitting, you agree to be contacted about your assessment.", submit: "Get Free Assessment", sending: "Sending request…", success: "Request received", successBody: "Thank you. We’ll review your photo and contact you when the assessment is ready.", again: "Submit another photo", error: "Something went wrong. Please try again." },
...
const ja: Copy = {
  ...
  hero: { eyebrow: "客室写真・予約ページ改善", title: "撮り直す前に、予約ページの見え方を整えます", body: "写真はあるのに、予約サイトでは客室の良さが伝わりきっていない場合があります。主写真、写真の並び、明るさ・色味を見直し、予約前のゲストが判断しやすい状態に整えます。撮影を手配する前に、まず今ある写真で改善できる点を整理します。", primary: "無料診断を申し込む", secondary: "改善事例を見る", trust: "相談は無料です。依頼を前提としたものではありません。" },
  ...
  why: { ...en.why, eyebrow: "予約サイト上の課題", title: "写真が予約につながりにくい理由", body: "課題は、写真の枚数や画質だけではありません。予約サイトの一覧画面で目に留まり、詳細ページで客室の広さ・清潔感・過ごし方が順番よく伝わるかが重要です。", cards: [["主写真が選ばれにくい", "一覧画面で小さく表示されても、客室の特徴が伝わる写真かを見直します。"], ["写真の順番で迷わせている", "ベッド、窓、浴室、設備、滞在シーンが自然に伝わる流れへ整理します。"], ["撮影前の判断が難しい", "撮り直すべきか、今ある写真で改善できるか、必要なカットは何かを先に整理します。"]] },
  optimize: { eyebrow: "見直すポイント", title: "きれいに加工するだけでなく、予約判断に必要な情報を整えます", items: ["主写真の見直し", "写真掲載順の整理", "明るさ・色味の調整", "広さ・清潔感の表現", "不足カットの整理"] },
  services: { ...en.services, eyebrow: "サービス内容", title: "カメラマンを手配しなくても、まず既存写真で整えられます", items: [["01", "客室写真・予約ページ改善", "既存写真をもとに、主写真、掲載順、明るさ、色味、客室の伝わり方を整えます。新たに撮影を手配しなくても、予約ページで使いやすい見え方へ近づけます。", "1枚 ¥200〜"], ["02", "内装アップグレード案", "家具・素材・見せ方の方向性を画像で確認できます。改装や撮影の前に、関係者の認識をそろえたい場合に有効です。", "¥4,000〜"]] },
  ...
  review: { ...en.review, eyebrow: "無料診断", title: "写真を送って、改善点を確認", body: "施設名やURLは必須ではありません。まず客室写真とメールアドレスだけで、改善できる方向を確認できます。", includes: ["優先して直したいポイント3点", "改善イメージが分かるサンプル画像1点", "必要に応じた追加撮影の方向性"], fields: ["施設名", "施設またはOTAページURL", "メールアドレス", "WhatsApp", "ご相談内容"], messagePlaceholder: "現在の写真で気になる点、撮り直しを検討している客室などがあればお聞かせください。", consent: "送信いただいた情報は、今回の診断とご連絡にのみ使用します。", submit: "無料診断を申し込む", sending: "送信中…", success: "お申し込みありがとうございます", successBody: "写真とご連絡先を受け付けました。確認後、担当者よりご連絡します。", again: "別の写真を診断する", error: "送信できませんでした。時間をおいて、もう一度お試しください。" },
  contact: { eyebrow: "ご相談", title: "撮影の前に、まず掲載ページを見直しませんか", location: "国内外のホテル・民泊に対応", button: "相談する" },
};
...
const zh: Copy = {
  ...
  review: { ...en.review, eyebrow: "免费评估", title: "上传照片，获取免费评估", body: "不一定需要先填写酒店名或网址。先上传客房照片并留下邮箱，我们会确认图片可改善的方向。", includes: ["3项优先优化建议", "1张免费优化样图", "OTA页面展示检查"], fields: ["酒店或民宿名称", "房源或OTA链接", "联系邮箱", "WhatsApp", "想重点改善的内容"], messagePlaceholder: "可以告诉我们目前最想改善哪类客房或哪组图片。", consent: "提交后，我们只会就本次免费评估与您联系。", submit: "提交免费评估", sending: "正在提交…", success: "提交成功", successBody: "我们已收到照片和联系信息。确认后，工作人员会与您联系。", again: "评估另一张照片", error: "暂时没有提交成功，请稍后再试。" },
