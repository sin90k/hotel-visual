...
const copy = {
  zh: {
    ...
    review: { title: "提交酒店链接，获取初步视觉评估", body: "我们将人工检查客房图片、主图排序与OTA页面呈现。", includes: ["3项优先优化建议", "1张示例参考图", "OTA页面展示检查", "客房图片调整方向"], fields: ["酒店或民宿名称", "官方网站", "Booking.com链接", "Airbnb链接", "联系邮箱", "WhatsApp", "想重点改善的内容"], button: "提交评估", sending: "正在提交…", success: "提交成功", successBody: "我们已收到房源信息。完成检查后，工作人员会与您联系。" },
  ...
  ja: {
    hero: { eyebrow: "宿泊施設の写真とゲスト対応", title: "客室の魅力を、予約につなげる。", body: "客室写真と予約サイトの見せ方を整え、予約前のゲストに魅力が伝わる状態をつくります。滞在中の小さな不満を早めに拾う仕組みも用意しています。", primary: "無料診断を申し込む", secondary: "改善事例を見る" },
    why: { title: "選ばれる客室の条件", body: "予約サイトでは、最初の数秒で「もっと見たい」と思ってもらえるかが決まります。", cards: [["一覧で目に留まる", "主写真の印象を整えます。"], ["予約の迷いを減らす", "広さや設備を明確に伝えます。"], ["料金への納得感", "客室の質を正しく見せます。"]] },
    ...
    review: { title: "施設ページの初期診断を承ります。", body: "客室写真と予約サイトでの見え方を、担当者が確認します。", includes: ["優先して直したいポイント3点", "改善イメージが分かるサンプル画像1点", "予約サイト上での見え方の診断", "客室の魅力を伝えるための改善案"], fields: ["施設名", "公式サイト", "Booking.com掲載ページ", "Airbnb掲載ページ", "メールアドレス", "WhatsApp", "ご相談内容"], button: "無料診断を申し込む", sending: "送信中…", success: "お申し込みありがとうございます", successBody: "施設情報を受け付けました。内容を確認し、担当者よりご連絡します。" },
