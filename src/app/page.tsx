...
export default function HomePage() {
  ...
  const uploadCopy = {
    en: { label: "Room photos", help: "Optional. Upload 1–5 room photos if available." },
    ja: { label: "客室写真", help: "任意。写真があれば1〜5枚アップロードできます。" },
    zh: { label: "客房照片", help: "选填。如方便，可上传1–5张客房照片。" },
  }[locale];
  const contactQr = {
