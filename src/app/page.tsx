...
const copy = {
  zh: {
    ...
    review: { title: "告诉我们想改善什么", body: "不一定需要先填写酒店名或网址。留下邮箱和想咨询的内容即可；如果方便，也可以上传几张客房照片帮助我们判断。", includes: ["3项优先优化建议", "1张示例参考图", "OTA页面展示检查", "客房图片调整方向"], fields: ["酒店或民宿名称", "房源或OTA链接", "联系邮箱", "微信或手机号", "想重点改善的内容"], button: "提交评估", sending: "正在提交…", success: "提交成功", successBody: "我们已收到您的咨询内容。确认后，工作人员会与您联系。" },
...
export default function HomePage() {
  ...
  const uploadCopy = {
    en: { label: "Room photos", choose: "Select photos", hint: "No file required", help: "Optional. Upload 1–5 room photos if available." },
    ja: { label: "客室写真", choose: "写真を選択", hint: "未選択でも送信できます", help: "任意。写真があれば1〜5枚アップロードできます。" },
    zh: { label: "客房照片", choose: "选择照片", hint: "不上传也可以提交", help: "选填。如方便，可上传1–5张客房照片。" },
  }[locale];
  const contactQr = {
