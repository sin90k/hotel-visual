...
const zh: Copy = {
  ...
  services: { ...en.services, eyebrow: "核心服务", title: "先把现有照\u2060片\u2060的\u2060价\u2060值发挥\u2060出\u2060来", items: [["01", "客房照片优化", "无需重新拍摄。我们会适度调整光线、色彩和空间层次，在保持真实感的前提下，让照片更适合携程、Airbnb、Booking.com等平台展示。", "$99 起"], ["02", "客房升级预览", "投入装修预算前，先直观看到家具、材质和空间调整后的呈现效果。", "$199 起"]] },
  ...
  review: { ...en.review, eyebrow: "免费评估", title: "发来酒店链接，免费帮您看\u2060一\u2060遍", body: "我们会人工检查客房图片、主图排序和OTA页面里的实际展示效果。", includes: ["3项优先优化建议", "1张免费优化样图", "OTA页面展示检查"], fields: ["酒店或民宿名称", "官方网站", "Booking.com链接", "Airbnb链接", "联系邮箱", "WhatsApp", "想重点改善的内容"], messagePlaceholder: "可以告诉我们目前最想改善哪类客房或哪组图片。", consent: "提交后，我们只会就本次免费评估与您联系。", submit: "提交免费评估", sending: "正在提交…", success: "提交成功", successBody: "我们已收到房源信息。完成检查后，工作人员会与您联系。", again: "评估另一家房源", error: "暂时没有提交成功，请稍后再试。" },
