...
const copy = {
  zh: {
    ...
    review: { title: "提交酒店链接，获取初步视觉评估", body: "我们会先根据页面整理可判断的问题，再由团队确认优先改善方向。", includes: ["3项优先优化建议", "1张示例参考图", "OTA页面展示检查", "客房图片调整方向"], fields: ["酒店或民宿名称", "房源或OTA链接", "联系邮箱", "WhatsApp", "想重点改善的内容"], button: "提交评估", sending: "正在提交…", success: "提交成功", successBody: "我们已收到房源信息。确认后，工作人员会与您联系。" },
  ...
  ja: {
    ...
    review: { title: "施設ページを送って、改善点を確認", body: "まずページ上で判断できる写真の課題を整理します。必要に応じて、担当者が詳しく確認します。", includes: ["優先して直したいポイント3点", "改善イメージが分かるサンプル画像1点", "必要に応じた追加撮影の方向性", "予約サイト上での見え方の診断"], fields: ["施設名", "施設またはOTAページURL", "メールアドレス", "WhatsApp", "ご相談内容"], button: "無料診断を申し込む", sending: "送信中…", success: "お申し込みありがとうございます", successBody: "施設情報を受け付けました。確認後、担当者よりご連絡します。" },
