...
const feedbackCopy = {
  ...
  ja: {
    eyebrow: "滞在中サービスリカバリー", title: "滞在中の声を拾い、すぐに対応する。", body: "客室QRからスマートフォン用Webページを開き、アプリや会員登録なしで困りごとを送信できます。届いた内容は判定・担当部署への共有・対応記録・責任者の確認を経て、完了まで追跡されます。", cta: "導入について相談する", back: "サービス一覧",
    problemTitle: "滞在中の行き違いが、低評価につながる。", problemBody: "タオルが足りない、空調の音が気になる、スタッフに伝える方法が分からない。早く気づければ解決できたことも、声を拾えないままでは口コミに残ってしまいます。",
  ...
  zh: {
    eyebrow: "酒店住中体验预警与服务恢复系统", title: "让住客的不\u2060满，在退\u2060房\u2060前被\u2060看\u2060见、被\u2060处\u2060理、被\u2060闭\u2060环", body: "住客扫描房间二维码进入微信小程序，可通过快捷选项、文字、语音、图片或视频提交客诉。系统识别风险后自动生成工单，让一线员工、经理和业主都能看到处理进展。", cta: "预约产品演示", back: "返回服务列表",
    problemTitle: "很多差评，退\u2060房\u2060前就能处理", problemBody: "少一条毛巾、空调噪声太大、客房清洁不到位，往往都不难处理。真正麻烦的是酒店一直不知道，直到差评已经发到平台上。",
    ...
    price: "$29 / 间起", final: "住\u2060客有不\u2060满，退\u2060房\u2060前告诉酒店", demo: "申请产品演示", why: "为什么要提前接住客诉", how: "客诉处理流程", demoUi: { room: "房间 1208", question: "您对本次入住哪里不满意？", issue: "客房设施", housekeeping: "卫生与清洁", other: "其他客诉", private: "仅酒店工作人员可见" },
  },
} as const;
