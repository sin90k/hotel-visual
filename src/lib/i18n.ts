...
const zh: Copy = {
  ...
  review: { ...en.review, eyebrow: "免费评估", title: "告诉我们想改善什么", body: "不一定需要先填写酒店名或网址。留下邮箱和想咨询的内容即可；如果方便，也可以上传几张客房照片帮助我们判断。", includes: ["3项优先优化建议", "1张免费优化样图", "OTA页面展示检查"], fields: ["酒店或民宿名称", "房源或OTA链接", "联系邮箱", "微信或手机号", "想重点改善的内容"], messagePlaceholder: "可以告诉我们目前最想改善哪类客房或哪组图片。", consent: "提交后，我们只会就本次免费评估与您联系。", submit: "提交免费评估", sending: "正在提交…", success: "提交成功", successBody: "我们已收到您的咨询内容。确认后，工作人员会与您联系。", again: "再提交一条咨询", error: "表单邮件暂未接通，请先扫码添加微信或发送邮件联系。" },
