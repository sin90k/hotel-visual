...
const feedbackCopy = {
  ...
  ja: {
    eyebrow: "ゲスト対応QR", title: "不満の声を、滞在中に拾う。", body: "客室QRからスマートフォン用ページを開き、届いた内容を担当部署へ共有します。対応状況を記録し、完了まで追跡できます。アプリは不要です。", cta: "導入について相談する", back: "サービス一覧",
    problemTitle: "低評価になる前に、館内で対応。", problemBody: "タオル不足、空調音、清掃の気になる点。滞在中に把握できれば、その場で案内や対応ができます。",
    benefits: [["施設へ直接届く", "投稿サイトを経由せず、内容と客室番号をスタッフが確認できます。"], ["チェックアウト前に対応", "滞在中に状況を把握できるため、その場での案内や対応が可能です。"], ["ゲストの手間が少ない", "アプリも会員登録も不要。読み取り、選択、送信だけで完了します。"]],
    ...
    system: { eyebrow: "対応を止めない仕組み", title: "届いた声を、対応タスクへ", body: "ゲストから届いた内容を、担当者・期限・対応状況が分かるタスクとして管理します。", capabilities: [["客室別Webページ", "QRを読み取ると、客室情報を引き継いだページが開きます。"], ["複数の入力方法", "選択肢・文章・音声・画像・動画で状況を伝えられます。"], ["リスク判定", "内容、緊急度、再送、対応遅れの兆候を確認します。"], ["対応タスクの作成", "客室、内容、優先度、担当候補をまとめて共有します。"], ["スタッフのモバイル対応", "担当者が受付、着手、対応内容、完了を記録します。"], ["責任者の確認", "高リスク、期限超過、再開した案件を一覧で確認できます。"], ["確認とレポート", "ゲスト確認、再開、傾向レポートまで管理します。"]] },
    stepsTitle: "受付から対応完了までの流れ", steps: [["Webページを開く", "客室QRから、客室情報付きのスマートフォン用ページを開きます。"], ["内容を送信", "項目を選び、文章・音声・画像・動画を追加できます。"], ["リスクを判定", "内容、緊急度、再送、対応遅れの兆候を確認します。"], ["対応タスクを作成", "フロント、客室、設備など適切な担当へ共有します。"], ["スタッフが対応", "受付、着手、対応内容、完了をモバイルで記録します。"], ["責任者が確認", "高リスクや期限超過の案件を督促します。"], ["確認して完了", "ゲストが解決を確認。未解決なら再開して対応を続けます。"]],
    roles: { eyebrow: "役割ごとの見え方", title: "必要な人に、必要な情報を", items: [["ゲスト", "アプリ不要で、困りごとをすぐ施設へ伝えられます。"], ["現場スタッフ", "客室、内容、担当、状態、対応履歴を一つのタスクで管理します。"], ["支配人・責任者", "高リスク、期限超過、再発、部署別の対応状況を確認できます。"], ["オーナー", "対応時間やリスク傾向から、サービス改善が機能しているか把握できます。"]] },
    ...
    price: "1室 $29〜", final: "不満の声を、退室前に拾える施設へ。", demo: "導入について相談する", why: "滞在中に声を拾う理由", how: "ご利用の流れ", demoUi: { room: "客室 1208", question: "お困りのことをお知らせください", issue: "客室設備について", housekeeping: "清掃・備品について", other: "その他のご相談", private: "内容は施設スタッフだけに届きます" },
  },
  zh: {
