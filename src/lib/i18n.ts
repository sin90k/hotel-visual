...
const en = {
  ...
  services: { eyebrow: "What we do", title: "Practical improvements that help rooms sell.", items: [
    ["01", "Room Photo Enhancement", "Transform existing room photos into more attractive booking assets without requiring a new photoshoot.", "Starting From $99"],
    ["02", "Room Upgrade Preview", "Visualize room improvements and interior upgrades before renovation investment.", "Starting From $199"],
  ] },
...
const ja: Copy = {
  ...
  services: { ...en.services, eyebrow: "サービス内容", title: "撮り直す前に、今ある写真でできることがあります。", items: [["01", "客室写真の見せ方改善", "過度な加工はせず、実際の客室らしさを保ったまま、明るさ・色・奥行きを整えます。", "$99〜"], ["02", "改装後のイメージ作成", "工事を始める前に、家具や内装を変えた客室のイメージを確認できます。", "$199〜"]] },
...
const zh: Copy = {
  ...
  hero: { eyebrow: "酒店客房图片优化", title: "让客人第一眼看见房间的价值", body: "优化现有客房照片与OTA页面的展示方式，让酒店和民宿的真实优势更容易被潜在客人看见。", primary: "获取免费评估", secondary: "查看优化案例", trust: "免费评估，不要求后续合作。" },
  ...
  why: { ...en.why, eyebrow: "影响客人下单的第一印象", title: "客人先看照片，再决定要不要订", body: "在OTA列表页里，客人通常只会用几秒钟筛选房源。主图能不能抓住注意力，客房优势能不能一眼看懂，都会影响后续下单。", cards: [["房源更容易被点开", "主图在同类房源里更醒目，客人才愿意继续看详情。"], ["客人下单更有底", "采光、空间和设施展示清楚，可以减少预订前的犹豫。"], ["房价更有说服力", "照片把客房档次和细节展示到位，价格也更容易被认可。"]] },
  optimize: { eyebrow: "优化内容", title: "我们优化什么？", items: ["光线优化", "色彩统一", "空间感增强", "床品质感提升", "OTA主图优化"] },
  services: { ...en.services, eyebrow: "核心服务", title: "先把现有照片的价值发挥出来", items: [["01", "客房照片优化", "无需重新拍摄。我们会适度调整光线、色彩和空间层次，在保持真实感的前提下，让照片更适合携程、Airbnb、Booking.com等平台展示。", "$99 起"], ["02", "客房升级预览", "投入装修预算前，先直观看到家具、材质和空间调整后的呈现效果。", "$199 起"]] },
  process: { ...en.process, eyebrow: "合作流程", title: "提交房源链接，先看看哪里最值得改善", support: "看完具体建议后，再决定是否需要继续合作。", steps: [["提交房源", "提供酒店官网或Booking.com、Airbnb房源链接。"], ["人工审核", "团队逐项检查照片、排序和OTA页面中的实际展示效果。"], ["收到建议", "获得3项优先优化建议和1张免费样图。"], ["决定是否继续", "评估本身不绑定后续服务。"]] },
  cases: { eyebrow: "优化方向", title: "图片调整后，客人能看到什么不同", note: "这里展示的是常见调整方向，不虚构点击率或订单增长数据。", outcomes: ["OTA主图更容易吸引注意", "客房采光与空间关系更清楚", "床品和装修材质更有质感", "客人更容易想象实际入住感受"], impact: "主要改善", mainLabel: "客房照片优化", mainTitle: "让客人在预订前，就看清房间的优势", main: "把采光、空间和细节展示清楚，让客人不用猜照片里到底是什么样。", secondaryLabel: "升级预览", secondary: "装修投入前，先确认家具、材质和布局调整是否合适。", thirdLabel: "别墅主图优化", thirdTitle: "不只拍房间，也要拍出住进去的感觉", third: "把室内、景观和生活场景串起来，让客人更容易想象完整的入住体验。", privateWindow: "房源页面检查" },
  trustSection: { eyebrow: "先把房间讲清楚", title: "照片越真实清楚，客人下单越放心", body: "采光、布局、床品和设施都展示到位，客人才知道自己订的是什么。我们不会用过度滤镜把房间修得失真，而是把原本就有的优势拍明白、讲清楚。" },
  review: { ...en.review, eyebrow: "免费评估", title: "发来酒店链接，免费帮您看一遍", body: "我们会人工检查客房图片、主图排序和OTA页面里的实际展示效果。", includes: ["3项优先优化建议", "1张免费优化样图", "OTA页面展示检查"], fields: ["酒店或民宿名称", "官方网站", "Booking.com链接", "Airbnb链接", "联系邮箱", "WhatsApp", "想重点改善的内容"], messagePlaceholder: "可以告诉我们目前最想改善哪类客房或哪组图片。", consent: "提交后，我们只会就本次免费评估与您联系。", submit: "提交免费评估", sending: "正在提交…", success: "提交成功", successBody: "我们已收到房源信息。完成检查后，工作人员会与您联系。", again: "评估另一家房源", error: "暂时没有提交成功，请稍后再试。" },
