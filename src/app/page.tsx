...
const copy = {
  ...
  ja: {
    ...
    products: { title: "ご提供するサービス", photo: { label: "中心となるサービス", title: "客室写真の見せ方改善", body: "撮り直しをしなくても、今ある写真から客室本来の魅力を引き出せます。", bullets: ["自然な明るさに調整", "写真全体の色味を統一", "奥行きと広がりを表現", "寝具の清潔感と質感を強調", "予約サイトのメイン写真を最適化", "再撮影は不要"], cta: "写真改善について見る" }, feedback: { label: "滞在中の声を拾う仕組み", title: "ご意見受付QR", body: "小さな不満が口コミになる前に、ゲストから施設へ直接伝えてもらえます。", bullets: ["施設へ直接届く", "滞在中に対応できる", "低評価口コミを未然に防ぐ", "アプリのダウンロード不要"], cta: "ご意見受付QRについて見る", example: { label: "利用イメージ", room: "客室 1208", title: "ご意見：空調の音", status: "施設へ通知済み・担当者が対応中" } } },
