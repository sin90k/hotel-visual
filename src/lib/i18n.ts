...
const ja: Copy = {
  ...
  review: { ...en.review, eyebrow: "無料診断", title: "施設ページを送って、改善点を確認", body: "まずページ上で判断できる写真の課題を整理します。必要に応じて、担当者が詳しく確認します。", includes: ["優先して直したいポイント3点", "改善イメージが分かるサンプル画像1点", "必要に応じた追加撮影の方向性"], fields: ["施設名", "施設またはOTAページURL", "メールアドレス", "WhatsApp", "ご相談内容"], messagePlaceholder: "現在の写真で気になる点、撮り直しを検討している客室などがあればお聞かせください。", consent: "送信いただいた情報は、今回の診断とご連絡にのみ使用します。", submit: "無料診断を申し込む", sending: "送信中…", success: "お申し込みありがとうございます", successBody: "施設情報を受け付けました。確認後、担当者よりご連絡します。", again: "別の施設を診断する", error: "送信できませんでした。時間をおいて、もう一度お試しください。" },
...
const zh: Copy = {
  ...
  review: { ...en.review, eyebrow: "免费评估", title: "提交酒店链接，获取免费评估", body: "我们会先根据页面整理可判断的问题，再由团队确认优先改善方向。", includes: ["3项优先优化建议", "1张免费优化样图", "OTA页面展示检查"], fields: ["酒店或民宿名称", "房源或OTA链接", "联系邮箱", "WhatsApp", "想重点改善的内容"], messagePlaceholder: "可以告诉我们目前最想改善哪类客房或哪组图片。", consent: "提交后，我们只会就本次免费评估与您联系。", submit: "提交免费评估", sending: "正在提交…", success: "提交成功", successBody: "我们已收到房源信息。确认后，工作人员会与您联系。", again: "评估另一家房源", error: "暂时没有提交成功，请稍后再试。" },
