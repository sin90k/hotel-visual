...
const feedbackCopy = {
  ...
  zh: {
    eyebrow: "酒店住中体验预警与服务恢复系统", title: "客诉不等退房，住中及时处理", body: "住客扫描房间二维码进入微信小程序，可通过快捷选项、文字、语音、图片或视频提交客诉。系统识别风险后自动生成工单，让一线员工、经理和业主都能看到处理进展。", cta: "预约产品演示", back: "返回服务列表",
    ...
    price: "$29 / 间起", final: "别把客诉留到退房后", demo: "申请产品演示", why: "为什么要提前接住客诉", how: "客诉处理流程", demoUi: { room: "房间 1208", question: "您对本次入住哪里不满意？", issue: "客房设施", housekeeping: "卫生与清洁", other: "其他客诉", private: "仅酒店工作人员可见" },
  },
} as const;
